...
enum Phase{GENERATE, DURATION, CANNON_COUNT, POWER_COUNT, INITIAL_TEXT, 
			REPLICATE_TEXT, ARENA, SCRIPT}
enum Minion{TROOPER, TANK, SPEEDER, HACKER, HACKERI, REDBLAST, BOMBER, 
			SLICK, GUARDIAN, CAPTAIN, BOSS}
